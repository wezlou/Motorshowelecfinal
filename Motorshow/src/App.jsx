...
const suggestedPartsImages = {
  thai: [
    { src: '/images/parts/2.jpg', label: 'Handle Bar' },
    { src: '/images/parts/13.jpg', label: 'Rims' },
    { src: '/images/parts/apr swing arm.jpg', label: 'Swing Arm' },
    { src: '/images/parts/cal2.jpg', label: 'Caliper' },
    { src: '/images/parts/flat3.jpg', label: 'Flatseat' },
  ],
  malaysian: [
    { src: '/images/parts/nlk pipe.jpg', label: 'Pipe' },
    { src: '/images/parts/MTV4.jpg', label: 'Outer tube' },
    { src: '/images/parts/Trc swing.jpg', label: 'Swing Arm' },
    { src: '/images/parts/magura.jpg', label: 'Throthle' },
    { src: '/images/parts/ducati3.jpg', label: 'Mags' },
  ],
  bigbike: [
    { src: '/images/parts/mufac handle bar.jpg', label: 'Handle Bar' },
    { src: '/images/parts/yamaha mags.jpg', label: 'Mags' },
    { src: '/images/parts/tire4.jpg', label: 'Big Tire' },
    { src: '/images/parts/Chifun shf.jpg', label: 'Quick shifter' },
    { src: '/images/parts/kawasaki.jpg', label: 'Telescopic' },
  ],
  vanz: [
    { src: '/images/parts/basket1.jpg', label: 'Basket' },
    { src: '/images/parts/blackleath2.jpg', label: 'Seat Cover' },
    { src: '/images/parts/flat 2.jpg', label: 'Flat Seat' },
    { src: '/images/parts/tire7.jpg', label: 'Tires' },
    { src: '/images/parts/wave dash.jpg', label: 'Telescopic' },
  ],
};
